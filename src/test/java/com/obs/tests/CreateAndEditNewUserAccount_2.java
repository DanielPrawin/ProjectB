...
public class CreateAndEditNewUserAccount_2 extends BasePage{
	...
	@Test
	public void CreateAndEditNewUserAccount_2() throws IOException, InterruptedException {
		...
		String EditlastName = "Vantela";
		String verify_EditlastName ="Vantela, DanielPrawin";
		log.info("Create New Account");		
		newAccountPage.NewUserCreation(AccountNumber,AccountFirstNameNumber,middleName,lastName,email,password,pin,balance);
		Thread.sleep(3000);
		manageAccountPage.SearchWithAccountNumberAndEditTheLastName(AccountNumber, EditlastName);
		manageAccountPage.SearchWithAccountNumberAndVerifyLastname(AccountNumber,verify_EditlastName);
