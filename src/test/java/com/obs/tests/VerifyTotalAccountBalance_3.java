...
import com.obs.pages.DashBoardPage;
import com.obs.pages.ManageAccountPage;
...
public class VerifyTotalAccountBalance_3 extends BasePage{
	...
	@Test
	public void VerifyTotalAccountBalance_3() throws IOException, InterruptedException {
		...
		ManageAccountPage manageAccountPage = new ManageAccountPage(driver,test);
		...
		String getTotalAccountBalanceBeforeCreatingNewUser=null;
		String getTotalAccountBalanceAfterCreatingNewUser=null;
		log.info("Create New Account");	
		getTotalAccountBalanceBeforeCreatingNewUser = dashBoardPage.getTotalAccountBalance();
		Thread.sleep(3000);
		System.out.println(getTotalAccountBalanceBeforeCreatingNewUser);
		newAccountPage.NewUserCreation(AccountNumber,AccountFirstNameNumber,middleName,lastName,email,password,pin,balance);
		Thread.sleep(3000);
		getTotalAccountBalanceAfterCreatingNewUser = dashBoardPage.getTotalAccountBalance();
		
		//Verify the Total Account Balance
		dashBoardPage.verifyTotalAccountBalance(getTotalAccountBalanceBeforeCreatingNewUser,getTotalAccountBalanceAfterCreatingNewUser,balance);
