...
public class VerifyTotalAccounts_4 extends BasePage{
	...
	@Test
	public void VerifyTotalAccounts_4() throws IOException, InterruptedException {
		...
		String getTotalAccounts_BeforeCreatingNewUserValue=null;
		String getTotalAccounts_AfterCreatingNewUserValue=null;
		log.info("Create New Account");	
		getTotalAccounts_BeforeCreatingNewUserValue = dashBoardPage.getTotalAccountsCount();
		Thread.sleep(3000);
		System.out.println(getTotalAccounts_BeforeCreatingNewUserValue);
		newAccountPage.NewUserCreation(AccountNumber,AccountFirstNameNumber,middleName,lastName,email,password,pin,balance);
		Thread.sleep(3000);
		getTotalAccounts_AfterCreatingNewUserValue = dashBoardPage.getTotalAccountsCount();
		
		//Verify the Total Account Balance
		dashBoardPage.verifyTotalAccountsCountValue(getTotalAccounts_BeforeCreatingNewUserValue,getTotalAccounts_AfterCreatingNewUserValue);
